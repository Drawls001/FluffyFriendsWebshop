...
<div style="display:none;" class="results col-6 mx-auto" id="Results">
  ...
  <label class="email  mb-2" style="text-decoration: underline;">Email: </label><br><label id="emial1"></label><br>
  ...
  <form action="" method="post">
    ...
    <div class="textarea ">
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" placeholder="I can't change my password." aria-label="Recipient's username" aria-describedby="button-addon2" id="topic" name="topic" maxlength="70">
